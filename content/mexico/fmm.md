...
- You are entering Mexico by land (car, bus, foot).
- You are entering by sea and disembarking.
- You are flying into a smaller airport that has not transitioned to the stamp-only system.
- You are staying more than the time granted by the passport stamp (rare for tourists).

**You may NOT need a separate FMM-E if:**
- You are flying into a major airport (CUN, MEX, GDL, TIJ, PVR, SJD, and several others). Most air arrivals now receive a passport stamp with the days authorized written on it, and this stamp serves the same purpose as the FMM.
...
### I filled out the form but didn't get a PDF.
...
### What do I do with the FMM stub at the border?
