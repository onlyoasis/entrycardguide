---
title: "印尼 All Indonesia / e-CD 2026 完整指南：官方网址、免费填写、巴厘岛入境"
...
faq:
  ...
  - q: "印尼 e-CD 的官方网址是什么？"
    a: "使用 allindonesia.imigrasi.go.id，这是当前统一入境申报入口。旧的 ecd.beacukai.go.id 海关门户仍可解析，但不再作为主要旅客入口。"
  - q: "我去巴厘岛也要填 e-CD 吗？"
    a: "要。印尼所有入境点都要求 e-CD，包括巴厘岛（DPS / 努拉莱国际机场）。抵达前 3 天内填一次，整趟行程只填一次。"
  - q: "e-CD 和落地签 e-VOA 是同一回事吗？"
    a: "不是，两者分开。e-CD 是海关申报（免费，所有入境者必填）。e-VOA 是签证，针对不享受免签的国家公民（政府费约 $35 美元，在 evisa.imigrasi.go.id 申请）。你的行程可能两者都需要。"
  - q: "什么时候填 e-CD？"
...
All Indonesia 入境申报是当前面向旅客的数字入口。它包含原本作为独立 e-CD 提交的海关申报记录：超额现金、受限物品、商业货物和应税商品。

它是免费的。

没有人能向你收这笔钱。当前官方目的地是 `allindonesia.imigrasi.go.id`。旧的独立海关门户 `ecd.beacukai.go.id` 仍可访问，但旅客应从 All Indonesia 开始。

## 这个不是签证

All Indonesia / e-CD 申报**不是签证**。它是入境和海关申报，与你的签证状态无关。如果你需要签证，单独在 `evisa.imigrasi.go.id` 申请 **e-VOA**（电子落地签），政府费用约 $35 美元。两者是不同的表、不同的收费规则。

## 问题在哪

Google 搜 *"巴厘岛海关表"* 或 *"印尼入境表"*，会看到付费广告，对免费的 e-CD 收 19 到 79 美元。其中一些代你提交了真表，另一些提交了不一样的表（有时是你没要求的 e-VOA），或干脆什么都没提交。

印尼政府现在通过 **All Indonesia** 引导旅客。申报仍然免费；任何向你收申报费的网站都是中介。

## 在动任何表单之前

看一眼地址栏。当前官方入口是 <mark>allindonesia.imigrasi.go.id</mark>。
